    ...
    <nav className="bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-12 py-4 flex items-center justify-between h-18">
        ...
        <div className="flex items-center gap-12">
          ...
          <a href="https://github.com/bmlancien" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-gray-600">
          ...
          <a href="https://www.linkedin.com/in/blancien/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-gray-600">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
