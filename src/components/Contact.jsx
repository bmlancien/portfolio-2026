    ...
    <section id="contact" className="bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-12 py-24">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold font-rajdhani text-gray-900 mb-6">Let's connect</h2>
          ...
          {/* Contact Button */}
          <button className="px-8 py-3 bg-gray-900 text-white font-medium font-rajdhani rounded-lg hover:bg-gray-800 transition">
            Contact me
          </button>
        </div>
      </div>
