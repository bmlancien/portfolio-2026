        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex gap-6">
              <a href="https://github.com/bmlancien" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-900 hover:text-gray-600">
              ...
              <a href="https://www.linkedin.com/in/blancien/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-900 hover:text-gray-600">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
